...
function Loginpage() {
    ...
    const [password, setPass] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const handleSubmit = (e)=>{
        e.preventDefault();
        if (isLogin) {
            console.log("Logging in with credentails");
        } else {
...
_s(Loginpage, "juZKj8ZYvyf9NuYjcG/Pf+L3a1s=");
_c = Loginpage;
var _c;
