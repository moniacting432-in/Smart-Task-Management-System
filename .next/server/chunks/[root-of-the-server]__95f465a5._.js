...
async function PUT(req, { params }) {
    await connectDB();
    const body = awaitreq.json();
    const updatedTask = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Task$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(params.id, body, {
        new: true
    });
...
async function DELETE(req, { params }) {
    await connectDB();
    const deletedTask = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Task$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(params.id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__95f465a5._.js.map